...
#python ~/QCXMS/scripts/YasinHelp/analysis_auto_protonation_heatmap_backup_green_on_exp.py mols.txt ~/QCXMS/workDir/neccessary_files/all_GNPS/delete_precursor_17 merged_predicted_spectra.mgf ~/QCXMS/workDir/neccessary_files/ALL_GNPS_cleaned.csv 4 3
import json
import pandas as pd
