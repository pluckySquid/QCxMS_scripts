...
# python ~/QCXMS/scripts/cosine_json_to_mgf_heatMap.py mols_accuracy_22-23_atoms.txt ~/QCXMS/workDir/neccessary_files/FDA-Part2/delete_precursor_20 merged_predicted_spectra.mgf ~/QCXMS/workDir/neccessary_files/ALL_GNPS_cleaned.csv 8 3
# python ~/QCXMS/scripts/cosine_json_to_mgf_heatMap.py mols_31-35_atoms.txt ~/QCXMS/workDir/neccessary_files/EMBL/GNPS-EMBL_delete_precursor merged_predicted_spectra.mgf ~/QCXMS/workDir/neccessary_files/ALL_GNPS_cleaned.csv 4 3
import argparse
import json
import pandas as pd
