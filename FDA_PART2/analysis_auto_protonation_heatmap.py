...
# python ~/QCXMS/scripts/FDA_PART2/analysis_auto_protonation_heatmap.py mols_echo_protonation.txt delete_precursor merged_predicted_spectra.mgf ~/QCXMS/workDir/neccessary_files/ALL_GNPS_cleaned.csv 4 3
import json
import pandas as pd
...
def plot_discription_function(describing_dict, predicted_mgf_dict, smile_peak_dict, experiment_index):
    result_dict = {}
    each_smile_dict = {}
...
def main():
    ...
    for experiment_index in range(1, 100):
        # try:
            ...
            plot_discription_function(describing_dict, predicted_mgf_dict, smile_peak_dict, experiment_index)
