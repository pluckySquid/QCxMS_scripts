...
# python ~/QCXMS/scripts/FDA_PART2/analysis_auto_protonation_heatmap_backup_green_on_exp.py mols_NIH_SMALL_first_23_atoms.txt ~/QCXMS/workDir/neccessary_files/NIH-Nature_round2_positive/NIH_Nature_round2_positive_delete_precursor_17 merged_predicted_spectra.mgf ~/QCXMS/workDir/neccessary_files/ALL_GNPS_cleaned.csv 1 3
import json
import pandas as pd
